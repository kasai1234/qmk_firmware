...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_QWERTY] = LAYOUT_for_Naked60_kc( \
  //,-----------------------------------------|             |-----------------------------------------|      |-----------------------------------------|
        ESC,     1,     2,     3,     4,     5,                   6,     7,     8,     9,     0,  BSPC,          LP0,    P1,    P4,    P7,   NAD,   ESC, \
  //|------+------+------+------+------+------|             |------+------+------+------+------+------|      |------+------+------+------+------+------|
        TAB,     Q,     W,     E,     R,     T,                   Y,     U,     I,     O,     P, JLBRC,                  P2,    P5,    P8,  PSLS,    F2, \
  //|------+------+------+------+------+------|             |------+------+------+------+------+------|      |------+------+------+------+------+------|
       LSFT,     A,     S,     D,     F,     G,                   H,     J,     K,     L,  MINS, JRBRC,         RPDO,    P3,    P6,    P9,  PAST,  PEQL, \
  //|------+------+------+------+------+------|             |------+------+------+------+------+------|      |-------------+-------------+------+------|
      LCTRL,     Z,     X,     C,     V,     B,                   N,     M,  COMM,   DOT,  SLSH, JENUN,                PENT,         PPLS,  PMNS,   DEL, \
  //|------+------+------+------+------+------|------+------+------+------+------+------+------+------|      |-----------------------------------------|
  ...
  //|------+------+------+------+------+------|             |------+------+------+------+------+------|      |------+------+------+------+------+------|
       SF11,    F1,    F2,    F3,    F4,    F5,               XXXXX,  LEFT,  DOWN, RIGHT,  LSFT,   ENT,        RAISE,    F3,    F6,    F9,  SCOU,  PEQL, \
  //|------+------+------+------+------+------|             |------+------+------+------+------+------|      |------+------+------+------+------+------|
  ...
  [_ADJUST] = LAYOUT_for_Naked60_kc( /* Base */
  //,-----------------------------------------|             |-----------------------------------------|      |-----------------------------------------|
        F11,    F1,    F2,    F3,    F4,    F5,                  F6,    F7,    F8,    F9,   F10,   F12,        LOWER,  LVAD,  LHUD,  LSAD,ADJUST,  LTOG, \
  //|------+------+------+------+------+------|             |------+------+------+------+------+------|      |------+------+------+------+------+------|
        ESC, XXXXX, XXXXX, XXXXX, XXXXX, XXXXX,               XXXXX,  BTN1,  MS_U,  BTN2, XXXXX, APSCR,                LVAI,  LHUI,  LSAI, XXXXX, _____, \
  //|------+------+------+------+------+------|             |------+------+------+------+------+------|      |------+------+------+------+------+------|
      XXXXX, XXXXX, XXXXX, XXXXX,  LMOD,  LTOG,               XXXXX,  MS_L,  MS_D,  MS_R, XXXXX,  PSCR,        RAISE, XXXXX, XXXXX, XXXXX, XXXXX, _____, \
  //|------+------+------+------+------+------|             |------+------+------+------+------+------|      |------+------+------+------+------+------|
       LSAI,  LSAD,  LHUI,  LHUD,  LVAI,  LVAD,               XXXXX, XXXXX, XXXXX, XXXXX, XXXXX,   CAD,                LMOD,        _____, _____, _____, \
  //|------+------+------+------+------+------|------+------+------+------+------+------+------+------|      |-----------------------------------------|
