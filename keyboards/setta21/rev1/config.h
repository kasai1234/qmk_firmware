...
// wiring of each half
#define MATRIX_COL_PINS { F4, F5, F6, F7, B1, B3, B2, B6, B4, B5, D1, D0 }
// #define MATRIX_COL_PINS { D0, D1, B5, B4, D6, B2, B3, B1, F7, F6, F5, F4 } //uncomment this line and comment line above if you need to reverse left-to-right key order
